    ...
    services: [
      {
        ...
        text1: 'fusionamos creatividad con estrategia para crear sitios personalizados que cautivan a tus visitantes y los convierten en clientes fieles.',
      ...
      },
      {
        ...
        text1: 'creamos sitios que no solo se ven bien—también funcionan.',
        text2: 'creamos sitios que no solo se ven bien—también funcionan.',
        img: isSmall ? contentVect : contentImg,
    ...
    services: [
      {
        ...
        text1: 'fusionem creativitat i estratègia per crear webs personalitzats que enganxin als visitants i els converteixin en clients fidels.',
      ...
      },
      {
        ...
        text1: 'creem webs que no només es veuen bé—també funcionen.',
        text2: 'creem webs que no només es veuen bé—també funcionen.',
        img: isSmall ? contentVect : contentImg,
