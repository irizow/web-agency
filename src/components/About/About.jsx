    ...
    return (
        <section id='about' className={styles.about}>
            ...
            className={styles.aboutdiv}>
                <h2>our approach</h2>
                <div>
                    <AboutCard title={'custom solutions'} img={customVect} description={"your website shouldn’t look like everyone else’s, just cause you're a small business. with original designs, we’ll bring your brand to life - no generic templates!"} delay={0.1}></AboutCard>
                    <AboutCard title={'fair & fresh'} img={isSmall ? fairVect : fairIcon} description={"you don’t have to spend a fortune to get a kickass website. we offer creative, high-quality solutions at a price that makes sense for small businesses"} delay={0.3}></AboutCard>
                    <AboutCard title={'ongoing support'} img={supportIcon} description={"once your site is live, we don’t disappear. we provide support if you need it and make sure your website continues to grow with you."} delay={0.5}></AboutCard>
                </div>
            </motion.div>
