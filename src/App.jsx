...
function App() {
  ...
  return (
    ...
    <div style={{padding: '2rem', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '10vh', height: '100vh', color: 'var(--white)', textAlign: 'center'}}>
